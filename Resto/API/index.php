...
$app->group('/cliente', function () {
    ...
    $this->get('/traer2id/{id_cliente}', \clienteApi::class . ':TraerUno');
  
    $this->post('/', \clienteApi::class . ':CargarUno');

    $this->post('/login', \clienteApi::class . ':Login');

    $this->post('/login-anon', \clienteApi::class . ':LoginAnon');
  
    $this->delete('/', \clienteApi::class . ':BorrarUno');
